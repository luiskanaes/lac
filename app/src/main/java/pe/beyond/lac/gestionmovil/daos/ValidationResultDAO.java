...
public class ValidationResultDAO extends BaseDAO {
	public static final String DAO_NAME = "ValidationResultDAO";
	public static final String TB_NAME = "GLS_GR_REL_RESULT_VALIDACION";
	public static final String COL_ID = "_id";
	public static final String COL_IDE_RESULTADO_VALIDACION = "IDE_RESULTADO_VALIDACION_RVA";
	...
	public static final String COL_FLG_EDICION = "FLG_EDICION_RVA";
	public static final String COL_DES_VALOR = "DES_VALOR_RVA";
	public static final String COL_DES_VALOR_REAL = "DES_VALOR_REAL_RVA";
	...
	private final String[][] TB_CREATE_INFO = new String[][] {
			...
			{ COL_IDE_RESULTADO_VALIDACION, Constants.INTEGER },
	...
	public static final int DAO_URI_CODE = 16;

	public static final int INSERT_URI_CODE = 1699;
	...
	public static final int QUERY_ONE_URI_CODE = 1601;
	...
	public static final int QUERY_ALL_URI_CODE = 1602;
	...
	public static final int QUERY_BY_VALIDATIONID_URI_CODE = 1603;
	public static final String QUERY_BY_VALIDATIONID_PATH = TB_NAME + Constants.LBL_SLASH
			+ "QueryByValidationId";
	public static final Uri QUERY_BY_VALIDATIONID_URI = Uri.parse("content://"
			+ Constants.CONFIGURATION_PROVIDER_AUTHORITY + Constants.LBL_SLASH
			+ QUERY_BY_VALIDATIONID_PATH);
	
	
	public static final int DELETE_ALL_URI_CODE = 1651;
	...
	public boolean onCreate(final SQLiteDatabase db) {
		...
		db.execSQL(createIndex(TB_NAME, COL_IDE_RESULTADO_VALIDACION));
		return true;
	}
	...
	public int loadDaoUris(final UriMatcher uriMatcher) {
		...
		uriMatcher.addURI(Constants.CONFIGURATION_PROVIDER_AUTHORITY,
				QUERY_BY_VALIDATIONID_PATH, QUERY_BY_VALIDATIONID_URI_CODE);
	...
	public Cursor query(Uri uri, Context context, SQLiteDatabase db,
		...
		case QUERY_ONE_URI_CODE:
			selection = " " + TB_NAME + Constants.LBL_DOT
				+ COL_IDE_RESULTADO_VALIDACION + " = ? ";
			break;
		case QUERY_ALL_URI_CODE:
			sortOrder = " " + TB_NAME + Constants.LBL_DOT
				+ COL_IDE_RESULTADO_VALIDACION + " ASC ";
			break;
		case QUERY_BY_VALIDATIONID_URI_CODE:
	...
	public static ContentValues createContentValues(final Generic entity) {
		ValidationResult sonEntity = (ValidationResult) entity;
		ContentValues values = new ContentValues();
		values.put(COL_IDE_RESULTADO_VALIDACION,
				sonEntity.getIntValidationResultId());
	...
	public static ValidationResult createObject(Cursor cursor) {
		if (cursor ==null || cursor.getCount()==0){
			return null;
		}
		int intValidationResultId = cursor.getInt(cursor
				.getColumnIndex(COL_IDE_RESULTADO_VALIDACION));
		...
		String strRealValue = cursor.getString(cursor
				.getColumnIndex(COL_DES_VALOR_REAL));
		int intState = cursor.getInt(cursor.getColumnIndex(COL_COD_ESTADO));
		ValidationResult objValidationResult = new ValidationResult(
				intValidationResultId, intValidationId, intQuestionId,
				booFlgEdition, strValue, strRealValue, intState);
		return objValidationResult;
	}

	public static List<ValidationResult> createObjects(Cursor cursor) {
		if (cursor ==null || cursor.getCount()==0){
			return null;
		}
		cursor.moveToFirst();
		List<ValidationResult> lst = new ArrayList<ValidationResult>();
		while (!cursor.isAfterLast()) {
			ValidationResult obj = createObject(cursor);
			lst.add(obj);
			cursor.moveToNext();
		}
		cursor.close();
