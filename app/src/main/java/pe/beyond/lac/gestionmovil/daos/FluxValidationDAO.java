...
public class FluxValidationDAO extends BaseDAO {
	public static final String DAO_NAME = "FluxValidationDAO";
	public static final String TB_NAME = "GLS_GR_REL_FLUJO_VALIDACION";
	public static final String COL_ID = "_id";
	public static final String COL_COD_FLUJO_VALIDACION = "COD_FLUJO_VALIDACION_FLV";
	public static final String COL_COD_FLUJO = "COD_FLUJO_RFL";
	public static final String COL_COD_VALIDACION = "COD_VALIDACION_VAL";
	public static final String COL_DES_VALOR = "DES_VALOR_FLV";

	private final String[][] TB_CREATE_INFO = new String[][] {
			{ COL_ID, Constants.INTEGER, Constants.PRIMARY_KEY },
			{ COL_COD_FLUJO_VALIDACION, Constants.INTEGER },
			{ COL_COD_FLUJO, Constants.INTEGER },
			{ COL_COD_VALIDACION, Constants.INTEGER },
			{ COL_DES_VALOR, Constants.TEXT }};

	public static final int DAO_URI_CODE = 31;

	public static final int INSERT_URI_CODE = 3199;
	...
	public static final int QUERY_ONE_URI_CODE = 3101;
	...
	public static final int QUERY_ALL_URI_CODE = 3102;
	...
	public static final int QUERY_BY_FLUXID_URI_CODE = 3103;
	public static final String QUERY_BY_FLUXID_PATH = TB_NAME + Constants.LBL_SLASH
			+ "QueryByFluxId";
	public static final Uri QUERY_BY_FLUXID_URI = Uri.parse("content://"
			+ Constants.CONFIGURATION_PROVIDER_AUTHORITY + Constants.LBL_SLASH
			+ QUERY_BY_FLUXID_PATH);
	
	public static final int DELETE_ALL_URI_CODE = 3151;
	...
	public boolean onCreate(final SQLiteDatabase db) {
		...
		db.execSQL(createIndex(TB_NAME, COL_COD_FLUJO_VALIDACION));
		return true;
	}
	...
	public static ContentValues createContentValues(final Generic entity) {
		FluxValidation sonEntity = (FluxValidation) entity;
		ContentValues values = new ContentValues();
		values.put(COL_COD_FLUJO_VALIDACION, sonEntity.getIntFluxValidationId());
	...
	public static FluxValidation createObject(Cursor cursor) {
		if (cursor ==null || cursor.getCount()==0){
			return null;
		}
		int intFluxValidationId = cursor.getInt(cursor.getColumnIndex(COL_COD_FLUJO_VALIDACION));
		...
		String strValue = cursor.getString(cursor.getColumnIndex(COL_DES_VALOR));
		
		FluxValidation objFlux = new FluxValidation(intFluxValidationId, intFluxId, intValidationId, strValue);
		return objFlux;
	}

	public static List<FluxValidation> createObjects(Cursor cursor) {
		if (cursor ==null || cursor.getCount()==0){
			return null;
		}
		cursor.moveToFirst();
		List<FluxValidation> lst = new ArrayList<FluxValidation>();
		while (!cursor.isAfterLast()) {
			FluxValidation obj = createObject(cursor);
			lst.add(obj);
			cursor.moveToNext();
		}
		cursor.close();
