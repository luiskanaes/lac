...
public class TemplateDAO extends BaseDAO {
	public static final String DAO_NAME = "TemplateDAO";
	public static final String TB_NAME = "GLS_GR_MAE_PLANTILLA";
	public static final String COL_ID = "_id";
	public static final String COL_COD_PLANTILLA = "COD_PLANTILLA_PLT";
	public static final String COL_DES_DESCRIPCION = "DES_DESCRIPCION_PLT";
	...
	public static final int DAO_URI_CODE = 13;

	public static final int INSERT_URI_CODE = 1399;
	...
	public static final int QUERY_ONE_URI_CODE = 1301;
	...
	public static final int QUERY_ALL_URI_CODE = 1302;
	...
	public static final int DELETE_ALL_URI_CODE = 1351;
	...
	public boolean onCreate(final SQLiteDatabase db) {
		...
		db.execSQL(createIndex(TB_NAME, COL_COD_PLANTILLA));
		return true;
	}
	...
	@Override
	public Uri insert(final Uri uri, final Context context,
			final SQLiteDatabase db, final int intUriCode,
	...
	public static ContentValues createContentValues(final Generic entity) {
		Template sonEntity = (Template) entity;
	...
	public static Template createObject(Cursor cursor) {
		...
		Template objTemplate = new Template(intTemplateId, strDescription,
				intState);
		return objTemplate;
	}

	public static List<Template> createObjects(Cursor cursor) {
		if (cursor ==null || cursor.getCount()==0){
			return null;
		}
		cursor.moveToFirst();
		...
		while (!cursor.isAfterLast()) {
			Template obj = createObject(cursor);
			lst.add(obj);
			cursor.moveToNext();
		}
		cursor.close();
