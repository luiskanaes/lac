...
package pe.beyond.zxing.maxicode;
...
import pe.beyond.zxing.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
   ...
   * case.
   *
   * @see pe.beyond.zxing.pdf417.PDF417Reader#extractPureBits(BitMatrix)
   * @see pe.beyond.zxing.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
   * @see pe.beyond.zxing.qrcode.QRCodeReader#extractPureBits(BitMatrix)
   */
